...
public class ManTipoPresentacion extends javax.swing.JDialog {
  ...
  // 💡 CAMBIOS CLAVE: Instancias de la Capa de Negocio
    ...
    public ManTipoPresentacion(java.awt.Frame parent, boolean modal) {
        ...
        this.setTitle("Mantenimiento de tipo de presentacion");
    }
   ...
   private void gestionarEstadoControles(String modo) {
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Tipo presentacion", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 1, 14))); // NOI18N
